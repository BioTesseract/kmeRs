...
Similarity score matrix for nucleic and amino acid k-mers is available. Similarity score is evaluated by PAM and/or BLOSUM substitution matrix. Higher similarity score indicates more similar sequences for BLOSUM and less similar sequences for PAM matrix. The 30, 40, 70, 120, 250 and 62, 45, 50, 62, 80, 100 matrix versions are available for PAM and BLOSUM, respectively. Alignment is evaluated by Needleman-Wunsch [@NEEDLEMAN1970443] and/or Smith-Waterman  [@SMITH1981195]. 
...
### Example 1. How to display PAM or BLOSUM matrix used for amino acides calculation?
...
### Example 5. How to display a similarity heatmap?
